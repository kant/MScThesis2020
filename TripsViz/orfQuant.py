...
def classify_regions_pos_neg(gene, sqlite_path_reads, sqlite_path_organism, regions, supported, exclude=True, count_type="range"):
...
def orfQuant(gene, sqlite_path_organism, sqlite_path_reads, supported, counts, filter=True):
    ...
    pos_neg_exons = classify_regions_pos_neg(gene, sqlite_path_reads, sqlite_path_organism, exons, supported, exclude=True, count_type="range")
...
#
#     orfQuant_res = orfQuant(gene, sqlite_path_organism, sqlite_path_reads, coding, counts, filter=True)
